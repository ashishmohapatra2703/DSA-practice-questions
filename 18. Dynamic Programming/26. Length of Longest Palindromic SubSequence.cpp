//print the length of Longest Palindromic Subsequence of the a string
#include <iostream>
#include <algorithm>
using namespace std;
...
int main()
{
    ...
    while(t--)
    {
        ...
        int lenLPS = LenLongestCommonSubSequence(X,Y,n,m); // Y is the reverse of X
        cout<< lenLPS <<endl; // lenLPS -> Length of Longest Palindromic Subsequence
    } 
}
